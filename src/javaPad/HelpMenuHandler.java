...
public class HelpMenuHandler implements ActionListener {
    ...
    private void displayAbout()
    {
        ...
        p1.add(image);      p1.add( new JLabel(javapad));
        ...
        card1.add( new JLabel(aboutJpad1));     card1.add( new JLabel(aboutJpad2));   card1.add( new JLabel(aboutJpad3)); 
        ...
        p2.add(card1, "card1");         p2.add(card2, "card2");
